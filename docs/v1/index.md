...
- **Output Files:**
  - *Description:* RDS file containing the filtered/transformed STList object for further processing. Also outputs various images including distribution plots before and after filtering, and pseudobulk PCA plot and heatmap.  
